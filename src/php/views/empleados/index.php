...
<div class="bg-white rounded-2xl border border-gray-100 shadow-sm">
    <div class="p-4 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center gap-3">
        ...
        <span class="text-xs text-gray-400"><?= count($empleados) ?> registros</span>
    </div>
    ...
    <div class="overflow-x-auto">
        <table class="table-modern w-full" id="tablaEmpleados">
            ...
            <tbody>
                ...
                <tr class="empty-row"><td colspan="4" class="empty-state"><p class="font-medium">No hay empleados registrados</p></td></tr>
                <?php else: ?>
...
<script>
document.addEventListener('DOMContentLoaded', () => filtrarTabla('buscarEmpleado', 'tablaEmpleados'));
</script>
